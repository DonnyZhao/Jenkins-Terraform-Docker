properties([ parameters([
  string( name: 'AWS_ACCESS_KEY_ID', defaultValue: 'AKIARCIVPQFCBSWPUXUQ'),
  string( name: 'AWS_SECRET_ACCESS_KEY', defaultValue: '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'),
